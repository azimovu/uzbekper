"""Pilot: stream islomov/news_youtube_uzbek_speech_dataset (id+text only),
...
json.dump(targets, open('/home/ubuntu/uzbekper/data/join_news_youtube.json', 'w'),
          ensure_ascii=False)
